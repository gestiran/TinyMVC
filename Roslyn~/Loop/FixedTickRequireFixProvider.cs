...
namespace TinyMVC.Roslyn.Loop {
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(FixedTickRequireFixProvider)), Shared]
    public sealed class FixedTickRequireFixProvider : InterfaceRequireFixProvider {
        public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(Labels.ID_FIXED_TICK);
        ...
        public FixedTickRequireFixProvider() {
            _title = "Add IFixedTick interface";
            _key = nameof(FixedTickRequireFixProvider);
