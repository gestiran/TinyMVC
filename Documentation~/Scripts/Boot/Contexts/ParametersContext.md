# [`ParametersContext`](/Scripts/Boot/Contexts/ParametersContext.cs)

Serves as a container for managing scene parameters, typically loaded as Unity `ScriptableObject`s with the [`IDependency`](/Documentation~/Scripts/Dependencies/IDependency.md) interface.
